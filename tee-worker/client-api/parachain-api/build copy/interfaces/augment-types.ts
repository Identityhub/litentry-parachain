...
import type {
    ...
    Web3Network,
    Web3ValidationData,
} from "parachain-api/interfaces/identity";
import type {
    AesOutput,
    AesRequest,
    DirectRequestStatus,
...
} from "parachain-api/interfaces/sidechain";
import type {
    TrustedCall,
    TrustedCallSigned,
    TrustedGetter,
...
} from "parachain-api/interfaces/trusted_operations";
import type {
    AchainableAmount,
    ...
    Web3NftType,
    Web3TokenType,
} from "parachain-api/interfaces/vc";
...
declare module "@polkadot/types/types/registry" {
    interface InterfaceTypes {
        ...
        AchainableAmount: AchainableAmount;
        AchainableAmountHolding: AchainableAmountHolding;
        AchainableAmounts: AchainableAmounts;
        AchainableAmountToken: AchainableAmountToken;
        AchainableBasic: AchainableBasic;
        AchainableBetweenPercents: AchainableBetweenPercents;
        AchainableClassOfYear: AchainableClassOfYear;
        AchainableDate: AchainableDate;
        AchainableDateInterval: AchainableDateInterval;
        AchainableDatePercent: AchainableDatePercent;
        AchainableParams: AchainableParams;
        AchainableToken: AchainableToken;
        ...
        BnbDigitDomainType: BnbDigitDomainType;
        BodyId: BodyId;
        BodyPart: BodyPart;
        bool: bool;
        Bool: Bool;
        ...
        DiscordValidationData: DiscordValidationData;
        ...
        Gas: Gas;
        GenericDiscordRoleContestType: GenericDiscordRoleContestType;
        GenericDiscordRoleSoraQuizType: GenericDiscordRoleSoraQuizType;
        GenericDiscordRoleType: GenericDiscordRoleType;
        GenericEventWithAccount: GenericEventWithAccount;
        Getter: Getter;
        GiltBid: GiltBid;
        ...
        OneBlockCourseType: OneBlockCourseType;
        ...
        RequestVcResultOrError: RequestVcResultOrError;
        ...
        SetId: SetId;
        SetIdentityNetworksResult: SetIdentityNetworksResult;
        SetIndex: SetIndex;
        ...
        VIP3MembershipCardLevel: VIP3MembershipCardLevel;
        Vote: Vote;
        VoteIndex: VoteIndex;
        Voter: Voter;
        VoterInfo: VoterInfo;
        ...
        Web3NftType: Web3NftType;
        Web3TokenType: Web3TokenType;
