...
declare module "@polkadot/api-base/types/submittable" {
    interface AugmentedSubmittables<ApiType extends ApiTypes> {
            ...
            setBalance: AugmentedSubmittable<
                (
                    who:
                        ...
                        | string
                        | Uint8Array,
                    addFree: Compact<u128> | AnyNumber | Uint8Array,
                    addReserved: Compact<u128> | AnyNumber | Uint8Array
        ...
        assetManager: {
            ...
            addAssetType: AugmentedSubmittable<
                (
                    ...
                    newAssetType: RuntimeCommonXcmImplCurrencyId | { SelfReserve: any } | { ParachainReserve: any } | string | Uint8Array
                ) => SubmittableExtrinsic<ApiType>,
            ...
            registerForeignAssetType: AugmentedSubmittable<
                (
                    assetType: RuntimeCommonXcmImplCurrencyId | { SelfReserve: any } | { ParachainReserve: any } | string | Uint8Array,
                    metadata:
                        | PalletAssetManagerAssetMetadata
        ...
        bitacross: {
             ...
             * ---------------------------------------------------
             **/
            btcWalletGenerated: AugmentedSubmittable<(pubKey: U8aFixed | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [U8aFixed]>;
            ethWalletGenerated: AugmentedSubmittable<(pubKey: U8aFixed | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [U8aFixed]>;
             ...
             **/
            setAdmin: AugmentedSubmittable<(newAdmin: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32]>;
            taskComplete: AugmentedSubmittable<() => SubmittableExtrinsic<ApiType>, []>;
        };
        bitacrossMimic: {
            /**
             * Set the admin account
             ...
             * Weights should be 2 DB writes: 1 for mode and 1 for event
             **/
            writeBtcToEth: AugmentedSubmittable<
                (
                    btcSender: U8aFixed | string | Uint8Array,
                    data:
                        | PalletBitacrossMimicCustodialTypeBtcToEth
                        | {
                              txIndex?: any;
                              btcTxHash?: any;
                              ethereumReceiver?: any;
                              ethereumTxHash?: any;
                              ethTxStatus?: any;
                              symbol?: any;
                              amount?: any;
                ...
                [U8aFixed, PalletBitacrossMimicCustodialTypeBtcToEth]
            >;
            writeEthToBtc: AugmentedSubmittable<
                (
                    ethSender: H160 | string | Uint8Array,
                    data:
                        | PalletBitacrossMimicCustodialTypeEthToBtc
                        | {
                              txIndex?: any;
                ...
                [H160, PalletBitacrossMimicCustodialTypeEthToBtc]
            >;
        };
        bounties: {
            /**
        ...
        democracy: {
            ...
            externalPropose: AugmentedSubmittable<
                (
                    proposal: FrameSupportPreimagesBounded | { Legacy: any } | { Inline: any } | { Lookup: any } | string | Uint8Array
                ) => SubmittableExtrinsic<ApiType>,
                [FrameSupportPreimagesBounded]
            >;
            /**
            ...
            setMetadata: AugmentedSubmittable<
                (
                    owner: PalletDemocracyMetadataOwner | { External: any } | { Proposal: any } | { Referendum: any } | string | Uint8Array,
        ...
        evmAssertions: {
            createAssertion: AugmentedSubmittable<
                (
                    id: H160 | string | Uint8Array,
                    byteCode: Bytes | string | Uint8Array,
                    secrets: Vec<Bytes> | (Bytes | string | Uint8Array)[]
                ) => SubmittableExtrinsic<ApiType>,
                [H160, Bytes, Vec<Bytes>]
            >;
        };
        extrinsicFilter: {
            /**
        ...
        identityManagement: {
            ...
            identityActivated: AugmentedSubmittable<
                (
                    primeIdentity:
                        ...
                        | string
                        | Uint8Array,
                    idGraphHash: H256 | string | Uint8Array,
                    reqExtHash: H256 | string | Uint8Array
                ) => SubmittableExtrinsic<ApiType>,
                [CorePrimitivesIdentity, H256, H256]
            >;
            ...
            identityLinked: AugmentedSubmittable<
                ...
                [CorePrimitivesIdentity, H256, H256]
            >;
            identityNetworksSet: AugmentedSubmittable<
                (
                    primeIdentity:
                        | CorePrimitivesIdentity
                        | { Twitter: any }
            ...
            someError: AugmentedSubmittable<
                ...
                [Option<CorePrimitivesIdentity>, CorePrimitivesErrorImpError, H256]
            >;
        };
        ...
        polkadotXcm: {
            ...
            forceSubscribeVersionNotify: AugmentedSubmittable<
                (location: XcmVersionedMultiLocation | { V2: any } | { V3: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>,
                [XcmVersionedMultiLocation]
            >;
            /**
        ...
        teebag: {
            forceAddEnclave: AugmentedSubmittable<
                (
                ...
                [AccountId32, PalletTeebagEnclave]
            >;
            forceRemoveEnclave: AugmentedSubmittable<
                (who: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>,
                [AccountId32]
            >;
            forceRemoveEnclaveByMrenclave: AugmentedSubmittable<
                (mrenclave: U8aFixed | string | Uint8Array) => SubmittableExtrinsic<ApiType>,
                [U8aFixed]
            >;
            forceRemoveEnclaveByWorkerType: AugmentedSubmittable<
                (workerType: PalletTeebagWorkerType | "Identity" | "BitAcross" | number | Uint8Array) => SubmittableExtrinsic<ApiType>,
                [PalletTeebagWorkerType]
            >;
            parentchainBlockProcessed: AugmentedSubmittable<
                (
                    blockHash: H256 | string | Uint8Array,
                    blockNumber: u32 | AnyNumber | Uint8Array,
                    taskMerkleRoot: H256 | string | Uint8Array
                ) => SubmittableExtrinsic<ApiType>,
                [H256, u32, H256]
            >;
            postOpaqueTask: AugmentedSubmittable<
                (request: PalletTeebagRsaRequest | { shard?: any; payload?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>,
                [PalletTeebagRsaRequest]
            >;
            registerEnclave: AugmentedSubmittable<
                (
                    workerType: PalletTeebagWorkerType | "Identity" | "BitAcross" | number | Uint8Array,
                    workerMode: PalletTeebagWorkerMode | "OffChainWorker" | "Sidechain" | number | Uint8Array,
                    attestation: Bytes | string | Uint8Array,
                    workerUrl: Bytes | string | Uint8Array,
                    shieldingPubkey: Option<Bytes> | null | Uint8Array | Bytes | string,
                    vcPubkey: Option<SpCoreEd25519Public> | null | Uint8Array | SpCoreEd25519Public | string,
                    attestationType: PalletTeebagAttestationType | { Ignore: any } | { Ias: any } | { Dcap: any } | string | Uint8Array
                ) => SubmittableExtrinsic<ApiType>,
                [
                    PalletTeebagWorkerType,
                    PalletTeebagWorkerMode,
            ...
            setMode: AugmentedSubmittable<
                (
                    newMode: PalletTeebagOperationalMode | "Production" | "Development" | "Maintenance" | number | Uint8Array
                ) => SubmittableExtrinsic<ApiType>,
                [PalletTeebagOperationalMode]
            >;
            setScheduledEnclave: AugmentedSubmittable<
                (
                    workerType: PalletTeebagWorkerType | "Identity" | "BitAcross" | number | Uint8Array,
                    sidechainBlockNumber: u64 | AnyNumber | Uint8Array,
                    mrenclave: U8aFixed | string | Uint8Array
                ) => SubmittableExtrinsic<ApiType>,
                [PalletTeebagWorkerType, u64, U8aFixed]
            >;
            sidechainBlockImported: AugmentedSubmittable<
                (
                    shard: H256 | string | Uint8Array,
        ...
        vcManagement: {
            ...
            requestVc: AugmentedSubmittable<
                (
                    ...
                    assertion:
                        ...
                        | { A20: any }
                        | { OneBlock: any }
                        | { GenericDiscordRole: any }
                        | { BnbDomainHolding: any }
                        | { BnbDigitDomainClub: any }
                        | { VIP3MembershipCard: any }
                        | { WeirdoGhostGangHolder: any }
                        | { LITStaking: any }
                        | { EVMAmountHolding: any }
                        | { BRC20AmountHolder: any }
                        | { CryptoSummary: any }
                        | { TokenHoldingAmount: any }
                        | { PlatformUser: any }
                        | { NftHolder: any }
                        | { Dynamic: any }
                        | string
            ...
            someError: AugmentedSubmittable<
                (
                    identity:
                        ...
                        | { Solana: any }
                        | string,
                    error: CorePrimitivesErrorVcmpError | { RequestVCFailed: any } | { UnclassifiedError: any } | string | Uint8Array,
                    reqExtHash: H256 | string | Uint8Array
                ) => SubmittableExtrinsic<ApiType>,
                [Option<CorePrimitivesIdentity>, CorePrimitivesErrorVcmpError, H256]
            >;
            /**
             * ---------------------------------------------------
             * The following extrinsics are supposed to be called by TEE only
            ...
            vcIssued: AugmentedSubmittable<
                ...
                [CorePrimitivesIdentity, CorePrimitivesAssertion, H256, H256]
            >;
        };
        ...
        xTokens: {
            ...
            transfer: AugmentedSubmittable<
                (
                    currencyId: RuntimeCommonXcmImplCurrencyId | { SelfReserve: any } | { ParachainReserve: any } | string | Uint8Array,
                    amount: u128 | AnyNumber | Uint8Array,
                    dest: XcmVersionedMultiLocation | { V2: any } | { V3: any } | string | Uint8Array,
            ...
            transferMulticurrencies: AugmentedSubmittable<
                (
                    currencies:
                        ...
                        | [
                              RuntimeCommonXcmImplCurrencyId | { SelfReserve: any } | { ParachainReserve: any } | string | Uint8Array,
