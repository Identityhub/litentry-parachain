...
declare module "@polkadot/api-base/types/events" {
    interface AugmentedEvents<ApiType extends ApiTypes> {
        assetManager: {
             ...
             **/
            UnitsPerSecondChanged: AugmentedEvent<ApiType, [assetId: u128, unitsPerSecond: u128], { assetId: u128; unitsPerSecond: u128 }>;
        };
        balances: {
            /**
        ...
        bitacross: {
            AdminSet: AugmentedEvent<ApiType, [newAdmin: Option<AccountId32>], { newAdmin: Option<AccountId32> }>;
            BtcWalletGenerated: AugmentedEvent<
                ApiType,
                [pubKey: U8aFixed, accountId: AccountId32],
                { pubKey: U8aFixed; accountId: AccountId32 }
            >;
            EthWalletGenerated: AugmentedEvent<ApiType, [pubKey: U8aFixed], { pubKey: U8aFixed }>;
            RelayerAdded: AugmentedEvent<ApiType, [who: CorePrimitivesIdentity], { who: CorePrimitivesIdentity }>;
            RelayerRemoved: AugmentedEvent<ApiType, [who: CorePrimitivesIdentity], { who: CorePrimitivesIdentity }>;
        };
        bitacrossMimic: {
            BtcToEthSaved: AugmentedEvent<ApiType, [btc: U8aFixed, txIndex: u64], { btc: U8aFixed; txIndex: u64 }>;
            EthToBtcSaved: AugmentedEvent<ApiType, [eth: H160, txIndex: u64], { eth: H160; txIndex: u64 }>;
        };
        bounties: {
            /**
        ...
        bridgeTransfer: {
             ...
             **/
            NativeTokenMinted: AugmentedEvent<ApiType, [to: AccountId32, amount: u128], { to: AccountId32; amount: u128 }>;
        };
        chainBridge: {
            /**
        ...
        evmAssertions: {
            AssertionCreated: AugmentedEvent<
                ApiType,
                [id: H160, byteCode: Bytes, secrets: Vec<Bytes>],
                { id: H160; byteCode: Bytes; secrets: Vec<Bytes> }
            >;
        };
        extrinsicFilter: {
        ...
        identityManagement: {
            ActivateIdentityFailed: AugmentedEvent<
                ApiType,
                [primeIdentity: Option<CorePrimitivesIdentity>, detail: CorePrimitivesErrorErrorDetail, reqExtHash: H256],
                { primeIdentity: Option<CorePrimitivesIdentity>; detail: CorePrimitivesErrorErrorDetail; reqExtHash: H256 }
            >;
            ActivateIdentityRequested: AugmentedEvent<
                ApiType,
                [shard: H256, account: AccountId32, encryptedIdentity: Bytes],
                { shard: H256; account: AccountId32; encryptedIdentity: Bytes }
            >;
            DeactivateIdentityFailed: AugmentedEvent<
                ...
                { primeIdentity: Option<CorePrimitivesIdentity>; detail: CorePrimitivesErrorErrorDetail; reqExtHash: H256 }
            >;
            DeactivateIdentityRequested: AugmentedEvent<
                ApiType,
                [shard: H256, account: AccountId32, encryptedIdentity: Bytes],
                { shard: H256; account: AccountId32; encryptedIdentity: Bytes }
            >;
            ...
            IdentityActivated: AugmentedEvent<
                ApiType,
                [primeIdentity: CorePrimitivesIdentity, idGraphHash: H256, reqExtHash: H256],
                { primeIdentity: CorePrimitivesIdentity; idGraphHash: H256; reqExtHash: H256 }
            >;
            ...
            IdentityLinked: AugmentedEvent<
                ...
                { primeIdentity: CorePrimitivesIdentity; idGraphHash: H256; reqExtHash: H256 }
            >;
            IdentityNetworksSet: AugmentedEvent<
                ApiType,
                [primeIdentity: CorePrimitivesIdentity, idGraphHash: H256, reqExtHash: H256],
                { primeIdentity: CorePrimitivesIdentity; idGraphHash: H256; reqExtHash: H256 }
            >;
            ...
            LinkIdentityFailed: AugmentedEvent<
                ...
                { primeIdentity: Option<CorePrimitivesIdentity>; detail: CorePrimitivesErrorErrorDetail; reqExtHash: H256 }
            >;
            LinkIdentityRequested: AugmentedEvent<
                ApiType,
                [shard: H256, account: AccountId32, encryptedIdentity: Bytes, encryptedValidationData: Bytes, encryptedWeb3networks: Bytes],
                {
                    shard: H256;
                    account: AccountId32;
        ...
        teebag: {
            AdminSet: AugmentedEvent<ApiType, [newAdmin: Option<AccountId32>], { newAdmin: Option<AccountId32> }>;
            EnclaveAdded: AugmentedEvent<
                ApiType,
                [who: AccountId32, workerType: PalletTeebagWorkerType, url: Bytes],
                { who: AccountId32; workerType: PalletTeebagWorkerType; url: Bytes }
            >;
            EnclaveRemoved: AugmentedEvent<ApiType, [who: AccountId32], { who: AccountId32 }>;
            ModeSet: AugmentedEvent<ApiType, [newMode: PalletTeebagOperationalMode], { newMode: PalletTeebagOperationalMode }>;
            OpaqueTaskPosted: AugmentedEvent<ApiType, [request: PalletTeebagRsaRequest], { request: PalletTeebagRsaRequest }>;
            ParentchainBlockProcessed: AugmentedEvent<
                ApiType,
                [who: AccountId32, blockNumber: u32, blockHash: H256, taskMerkleRoot: H256],
                { who: AccountId32; blockNumber: u32; blockHash: H256; taskMerkleRoot: H256 }
            >;
            ScheduledEnclaveRemoved: AugmentedEvent<
                ApiType,
                [workerType: PalletTeebagWorkerType, sidechainBlockNumber: u64],
                { workerType: PalletTeebagWorkerType; sidechainBlockNumber: u64 }
            >;
            ScheduledEnclaveSet: AugmentedEvent<
                ApiType,
                [workerType: PalletTeebagWorkerType, sidechainBlockNumber: u64, mrenclave: U8aFixed],
                { workerType: PalletTeebagWorkerType; sidechainBlockNumber: u64; mrenclave: U8aFixed }
            >;
            SidechainBlockFinalized: AugmentedEvent<
                ApiType,
                [who: AccountId32, sidechainBlockNumber: u64],
                { who: AccountId32; sidechainBlockNumber: u64 }
            >;
        };
        tips: {
        ...
        vcManagement: {
            ...
            UnclassifiedError: AugmentedEvent<
                ApiType,
                [identity: Option<CorePrimitivesIdentity>, detail: CorePrimitivesErrorErrorDetail, reqExtHash: H256],
                { identity: Option<CorePrimitivesIdentity>; detail: CorePrimitivesErrorErrorDetail; reqExtHash: H256 }
            >;
            VCIssued: AugmentedEvent<
                ApiType,
                [identity: CorePrimitivesIdentity, assertion: CorePrimitivesAssertion, idGraphHash: H256, reqExtHash: H256],
                { identity: CorePrimitivesIdentity; assertion: CorePrimitivesAssertion; idGraphHash: H256; reqExtHash: H256 }
            >;
