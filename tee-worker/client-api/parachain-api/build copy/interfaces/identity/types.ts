...
/** @name Address33 */
export interface Address33 extends U8aFixed {}

/** @name BitcoinSignature */
export interface BitcoinSignature extends U8aFixed {}
...
export interface Ed25519Signature extends U8aFixed {}
...
export interface LitentryIdentity extends Enum {
    ...
    readonly asBitcoin: Address33;
    readonly isSolana: boolean;
    readonly asSolana: Address32;
...
export interface LitentryMultiSignature extends Enum {
    ...
    readonly isBitcoin: boolean;
    readonly asBitcoin: BitcoinSignature;
...
export interface Sr25519Signature extends U8aFixed {}
